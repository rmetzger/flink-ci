...
RUN set -eux; \
	apt-get update; \
	apt-get install -y gosu sudo locales make less git curl libapr1 unzip uuid-runtime jq bsdmainutils wget python docker.io wget software-properties-common apt-transport-https; \
