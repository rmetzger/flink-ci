...
RUN set -eux; \
	...
	apt-get install -y gosu sudo locales make less git openjdk-8-jdk curl libapr1 unzip uuid-runtime jq bsdmainutils wget python docker.io software-properties-common apt-transport-https; \
